...
public class Menu extends CustomJPanel {
	...
	private void initComponent() {
		...
		String titleAndDev = "<html><span style = \"font-weight: bold; color: #fff; font-size: 25px;\">Sorting Visualizer</span><br>";
		...
		stop.setVisible(true); // sort is currently shown
	...
	private ImageIcon[] setUpIcon(int dim) {
		String paths[] = {
				"/resources/burger-icon-enabled.png",
				"/resources/burger-icon-disabled.png",
				"/resources/sort-icon-enabled.png",
				"/resources/sort-icon-disabled.png",
				"/resources/shuffle-icon-enabled.png",
				"/resources/shuffle-icon-disabled.png",
				"/resources/stop-icon-enabled.png"
		};
