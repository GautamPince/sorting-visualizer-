...
public class CustomJButton extends JButton {
	 ...
	 * @param enabled_icon  The image to be displayed by the CustomJButton when
	 *                      enabled.
	 * @param disabled_icon The image to be displayed by the CustomJButton when
	 *                      disabled.
