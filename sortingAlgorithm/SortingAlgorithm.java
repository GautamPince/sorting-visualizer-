...
// 	MERGE_SORT(new MergeSort(), new String[] { "\u03a9(n log(n))", "\u0398(n log(n))", "\u039f(n log(n))" },
// 			"\u039f(n)"),
// 	QUICK_SORT(new QuickSort(), new String[] { "\u03a9(n log(n))", "\u0398(n log(n))", "\u039f(n^2)" },
// 			"\u039f(log(n))"),
// 	BOGO_SORT(new BogoSort(), new String[] { "\u03a9(n)", "\u0398((n+1)!)", "\u039f((n+1)!)" }, "\u039f(n)");
// 	// HEAP_SORT(new HeapSort(), new String[] { "\u03a9(n)", "\u0398((n+1)!)", "\u039f((n+1)!)" }, "\u039f(n)");
...
public enum SortingAlgorithm {
    ...
    QUICK_SORT(new QuickSort(), new String[] { "\u03a9(n log(n))", "\u0398(n log(n))", "\u039f(n^2)" },
            "\u039f(log(n))"),
    BOGO_SORT(new BogoSort(), new String[] { "\u03a9(n)", "\u0398((n+1)!)", "\u039f((n+1)!)" }, "\u039f(n)"),
    HEAP_SORT(new HeapSort(), new String[] { "\u03a9(n log(n))", "\u0398(n log(n))", "\u039f(n log(n))" }, "\u039f(1)");
